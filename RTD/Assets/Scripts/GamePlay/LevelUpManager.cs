...
public class LevelUpManager : MonoBehaviour
{
    ...
    void LevelUpUnion()
    {
        ...
        {
            Union.Level += 1;
            CharUtils.UpdateSpecificUnion(CharacterKit.UNION.UNION001, Union.Level);
        }
        else
        {
    ...
    void LevelUpDemic()
    {
        ...
        {
            Demic.Level += 1;
            CharUtils.UpdateSpecificUnion(CharacterKit.UNION.UNION002, Demic.Level);
        }
        else
        {
            Debug.Log(ResponseMessage.Trade.Receive(response));
    ...
    void LevelUpExis()
    {
        ...
        {
            Exis.Level += 1;
            CharUtils.UpdateSpecificUnion(CharacterKit.UNION.UNION003, Exis.Level);
        }
        else
        {
            Debug.Log(ResponseMessage.Trade.Receive(response));
    ...
    int GetLevel(CharacterKit.UNION union)
    {
        ...
        switch(union)
        {
            case CharacterKit.UNION.UNION001:
                level = Union.Level;
                break;
            case CharacterKit.UNION.UNION002:
                level = Demic.Level;
                break;
            case CharacterKit.UNION.UNION003:
                level = Exis.Level;
                break;
        }
        return level;
